...
public class Asteroides extends Sprite {
	...
	public Asteroides(float x, float y,int lifemax, NaveBase naveBase) {
		this.X = x;
		this.Y = y;
	...
	public void SimulaSe(int diftime) {
		...
		for (int i = 0; i < CanvasMain.listaDePersonagens.size(); i++) {
			Asteroides pers = (Asteroides) CanvasMain.listaDePersonagens.get(i);
...
//				}
	...
	public boolean testaColisao(Asteroides pers) {
	...
	public boolean ColisaoRetangular(Asteroides pers) {
		float p1x1 = X + 2;
		float p1x2 = X + 30;
		float p2x1 = pers.X + 2;
